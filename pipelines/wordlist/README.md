...
Builds:
- `data/wordlist/selected-words.csv`
...
```bash
cp data/wordlist/selected-words.csv data/wordlist/edited-words.csv
```

Then manually edit `data/wordlist/edited-words.csv`.
Keep `Number` unchanged and edit only `word`.

### 3. `03-build-word-metadata-input.ts`

Reads:
- `data/wordlist/edited-words.csv`

Builds:
- `data/wordlist/word-metadata-input.csv`
...
```bash
cp data/wordlist/word-metadata-input.csv data/wordlist/word-metadata-completed.csv
```

Then manually edit `data/wordlist/word-metadata-completed.csv`:
...
Reads:
- `data/wordlist/word-metadata-completed.csv`
