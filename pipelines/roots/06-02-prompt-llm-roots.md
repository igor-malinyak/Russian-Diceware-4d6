...
- `pipelines/roots/06-03-split-llm-roots.ts`
- `pipelines/roots/06-04-merge-llm-roots.ts`
...
2. Use `pipelines/roots/06-03-split-llm-roots.ts` to split it into chunk pairs under `data/roots/llm-roots.chunks`.
...
10. After all chunks are filled, use `pipelines/roots/06-04-merge-llm-roots.ts` to assemble `data/roots/llm-roots.llm.csv`.
