...
- `pipelines/roots/03-03-split-llm-tikhonov-root-mapping.ts`
- `pipelines/roots/03-04-merge-llm-tikhonov-root-mapping.ts`
...
2. Use `pipelines/roots/03-03-split-llm-tikhonov-root-mapping.ts` to split it into chunk pairs under `data/roots/llm-tikhonov-root-mapping.chunks`.
...
10. After all chunks are filled, use `pipelines/roots/03-04-merge-llm-tikhonov-root-mapping.ts` to assemble `data/roots/llm-tikhonov-root-mapping.llm.csv`.
