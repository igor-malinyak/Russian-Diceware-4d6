...
- `data/selection/final-candidates-selected-1296.csv`
- `data/selection/final-candidates-selected-1000.csv`
...
Создаёт:
- `data/selection/dictionary-top-ranked.csv`
- `data/selection/extra-lemmas-ranked.csv`
- `data/selection/manual-selection.csv`
...
```bash
cp data/selection/manual-selection.csv data/selection/manual-selection-completed.csv
```

Затем вручную отредактировать `data/selection/manual-selection-completed.csv`:
...
Читает:
- `data/selection/manual-selection-completed.csv`
...
Создаёт:
- `data/selection/final-candidates-ranked.csv`
...
```bash
cp data/selection/final-candidates-ranked.csv data/selection/final-candidates-selected-1296.csv
```
...
```bash
cp data/selection/final-candidates-selected-1296.csv data/selection/final-candidates-selected-1000.csv
```
