...
## Методика
Этот процесс присваивает корни леммам из `source/data/roots/dictionary-source.csv`.
...
У этого процесса два конечных артефакта:
- `source/data/roots/dictionary-source-with-roots.csv` — финальный словарь лемм с полем `roots`, где всегда записан `canonical_root`
