...
- для каждого такого корня берутся наиболее частотные леммы
...
После этого оценки присоединяются обратно к рабочему списку, и получается итоговый файл с атрибутами.
